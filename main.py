...
def main(cli_args: Optional[List[str]] = None) -> None:
    ...
    print("\n[1/4] Extracting data from sources...")
    ...
    raw_nuvio = nuvio_extractor.extract()
    print(f"  - Nuvio JSON: {len(raw_nuvio)} items extracted ({cfg.nuvio_export_file})")
    ...
    # 3. Normalize Sources
    print("\n[2/4] Normalizing all items into canonical media records...")
    ...
    # 5. Export Master Datasets & Reports & Payloads
    out_dir = Path(cfg.output_dir)
    print(f"\n[4/4] Exporting master datasets and service payloads to '{out_dir}'...")
